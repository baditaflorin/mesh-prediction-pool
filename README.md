# mesh-prediction-pool

[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-prediction-pool-88dd88)](https://baditaflorin.github.io/mesh-prediction-pool/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-prediction-pool/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> Imaginary-token futures market. Open, bet, creator resolves, winners split the pool.

**Live → https://baditaflorin.github.io/mesh-prediction-pool/**

**Source → https://github.com/baditaflorin/mesh-prediction-pool**
...
git clone https://github.com/baditaflorin/mesh-prediction-pool
cd mesh-prediction-pool
npm install
npm run dev
```
...
- `mesh-prediction-pool:signalingUrl`
- `mesh-prediction-pool:turnTokenUrl`
- `mesh-prediction-pool:iceServers`
- `mesh-prediction-pool:room`
